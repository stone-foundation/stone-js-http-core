...
describe('File', () => {
  ...
  describe('getHashedContent', () => {
    ...
    it('should throw error when file cannot be read', () => {
      ...
      expect(() => file.getContent()).toThrow(FileError)
    })

    it('should throw error on invalid file', () => {
      (existsSync as Mock).mockReturnValue(false)
      expect(() => File.create('/path/to/file.txt')).toThrow(FileError)
    })
  })
  ...
  describe('write', () => {
    ...
    it('should throw error when file cannot be wrote', () => {
      ...
      expect(() => file.write('')).toThrow(FileError)
    })
  })
  ...
  describe('remove', () => {
    ...
    it('should throw error when file cannot be removed', () => {
      ...
      const file = File.create('/path/to/file.txt', false)
      expect(() => file.remove()).toThrow(FileError)
    })
  })
  ...
  describe('move', () => {
    ...
    it('should throw error on invalid access while creating file', () => {
      ...
      const file = File.create('/path/to/file.txt', false)
      expect(() => file.move('/path/to/file2.txt')).toThrow(FileError)
    })
