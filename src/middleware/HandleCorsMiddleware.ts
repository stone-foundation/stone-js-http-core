...
import { IBlueprint, IncomingEvent, KernelContext, OutgoingResponse } from "@stone-js/core";
 ...
 */
export class HandleCorsMiddleware<U extends IncomingEvent, V extends OutgoingResponse> {
